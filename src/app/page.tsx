  ...
  return (
    <div className="font-thin">
      ...
      <div className="landing-page flex flex-col items-center text-center space-y-20">
        <div className="shrink flex w-full max-w-sm items-center space-x-2">
          <Button
            variant="outline"
            type="submit"
        ...
        <div>
          <div className="sm:text-6xl text-3xl font-medium">
        ...
        <div>
          <div className="sm:text-6xl font-medium">
        ...
        <div className="sm:flex sm:flex-row place-content-center sm:space-x-11 space-y-6">
          <div className="flex flex-col text-wrap sm:w-1/5">
            <div className={`text-7xl place-self-center ${landing.icon}`}>
              <div className={landing.iconIn}>
                <GoPerson />
              </div>
            </div>
            <div className="sm:text-xl font-medium m-5">
          ...
          <div className="flex flex-col text-wrap sm:w-1/5">
            ...
            <div className="sm:text-xl font-medium m-5">Add services</div>
          ...
          <div className="flex flex-col text-wrap sm:w-1/5">
            ...
            <div className="sm:text-xl font-medium m-5">Built Website</div>
        ...
        >
          <div className="sm:text-6xl mb-6 font-medium">Why Rmax?</div>
        ...
        <div className="sm:grid sm:grid-rows-9 shrink gap-4 grid-cols-3 grid-flow-col size-2/4 w-2/3 h-3/3">
          <div className={`row-span-3 space-y-7 ${landing.boxBorder}`}>
            <div
              className={`sm:text-4xl flex place-content-center mt-7 ${landing.colorPricingName}`}
            >
              <SlCalender />
            </div>
            <div
          ...
          >
            ...
            >
              <div className="font-medium mb-3">Billing & Payments</div>
              <br />
          ...
          <div className={`space-y-7 row-span-4 ${landing.boxBorder}`}>
            <div
              className={`sm:text-4xl flex place-content-center mt-20 ${landing.colorPricingName}`}
            >
              <SlBriefcase />
            </div>
            <div
          ...
          <div className={`space-y-7 row-span-2 ${landing.boxBorder}`}>
            <div
              className={`flex flex-col place-items-center space-y-4 ${landing.boxText}`}
            >
              <div className="font-medium mt-9 mb-7">
          ...
          >
            <div
              className={`sm:text-6xl flex place-content-center mt-7 ${landing.colorPricingName}`}
            >
              <GiSparkles />
            </div>
            <div
        ...
        <div className="sm:flex sm:flex-row" style={{ gap: "2vw" }}>
          <div className={landing.boxPricing}>
            <div className={landing.colorPricingName}>Starter</div>
            <br /> <span className="sm:text-5xl font-bold">$17</span> / month
            <br /> billed monthly
            <br />
            <div className="flex flex-row mt-10 place-items-center">
              <VscCheck style={{ color: "green" }} className="sm:text-xl" /> &nbsp;
              Commercial License
            </div>
            <br />
            ...
            >
              <VscClose className="sm:text-xl" /> &nbsp; 6 Month Premium Support
            </div>
            <br />
            <div
              className="flex flex-row place-items-center"
              style={{ color: "rgba(128, 128, 128, 0.511)" }}
            >
              <VscClose className="sm:text-xl" /> &nbsp; Life Time Updates
            </div>
            <div className="felx flex-col place-items-center mt-7">
              <button className={` font-medium ${landing.orangeButtonLight}`}>
                Get Started →
              </button>
              <div className="font-thin text-xs">No credit card required</div>
            </div>
          </div>
          <div className={landing.boxPricing}>
            <div className={landing.colorPricingName}>Premium</div>
            <br />
            <span className="sm:text-5xl font-bold">$88</span> / month
            <br /> billed monthly
            <div className="flex flex-row mt-10 place-items-center">
              <VscCheck style={{ color: "green" }} className="sm:text-xl" /> &nbsp;
              Commercial License
        ...
        <div>
          <div className="sm:text-6xl mb-3 font-medium">
        ...
        <div className="flex flex-row gap-5 sm:text-3xl font-normal">
          <div
